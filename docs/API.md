...
- `sessionId` (path): Session identifier to backup
...
```json
{
  ...
  "data": {
    ...
    "filename": "session-uuid_2025-01-08_12-00-00.json",
...
#### `GET /sessions/:sessionId/backups`
...
- `sessionId` (path): Target session identifier
...
```json
{
  ...
  "data": {
    ...
    "restoredAt": "2025-01-08T12:05:00.000Z"
  }
}
```
